...
export function generateStaticParams() {
  return getCityServicePagesForBrand("nexcel").map((p) => ({
    city: p.citySlug,
...
export default function NexcelCityServicePage({ params }: PageProps) {
  const page = getCityServicePage("nexcel", params.city, params.service);
  if (!page) notFound();
  return (
    <>
