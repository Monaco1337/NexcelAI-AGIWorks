...
export default function NexcelWissenHub() {
    ...
    <div className="relative min-h-screen overflow-x-hidden">
      <div className="pt-[76px] sm:pt-[88px]">
        <HubTemplate
          ...
          title="Wissen"
          intro="Erklärungen und Leitfäden rund um KI, Automatisierung und Customer Experience — sachlich, ohne Buzzwords, für fundierte Entscheidungen."
