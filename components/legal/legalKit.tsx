...
export const NEXCEL_ENTITY: LegalEntity = {
  ...
  street: "Hemmerder Dorfstraße 111",
  zipCity: "59427 Unna",
  country: "Deutschland",
  emails: ["info@nexcelai.com", "kontakt@nexcelai.com", "support@nexcelai.com"],
  primaryEmail: "info@nexcelai.com",
  phone: "+49 163 9166073",
  phoneHref: "tel:+491639166073",
  website: "www.nexcelai.com",
  homeHref: "/",
...
export const AGI_ENTITY: LegalEntity = {
  ...
  zipCity: "59423 Unna",
  country: "Deutschland",
  emails: ["info@agiworks.de", "kontakt@agiworks.de"],
