...
export default function DatenschutzView({ theme, entity }: { theme: LegalTheme; entity: LegalEntity }) {
  const sections: LegalSection[] = [
    /* 1 — Einleitung */
    {
      ...
      content: (
        <Card>
          <Para>
            Der Schutz personenbezogener Daten hat für {entity.brandName} höchste Priorität. Wir
            verarbeiten personenbezogene Daten ausschließlich im Einklang mit den geltenden
            datenschutzrechtlichen Vorschriften, insbesondere der Datenschutz-Grundverordnung (DSGVO),
            dem Bundesdatenschutzgesetz (BDSG), dem
            Telekommunikation-Digitale-Dienste-Datenschutz-Gesetz (TDDDG) sowie weiteren anwendbaren
            europäischen und nationalen Bestimmungen. Soweit KI-Systeme eingesetzt werden,
            berücksichtigen wir zusätzlich die Vorgaben der Verordnung (EU) 2024/1689
            (EU-KI-Verordnung bzw. AI Act).
          </Para>
          <div className="mt-4">
            <Para>
              ...
              ({entity.website}), unserer Analyse- und Diagnosesysteme sowie unserer
      ...
      content: (
        <div className="space-y-4">
          <Card>
            ...
            <p className="text-lg font-semibold text-[#FFFFFF] mb-2">{entity.ownerWithBrand}</p>
            <p className="text-[#E5E7EB] leading-relaxed">
              {entity.street}
              <br />
              {entity.zipCity}, {entity.country}
            </p>
          </Card>
          <Card>
            <Label>Kontakt</Label>
            <div className="space-y-2">
              {entity.emails.map((mail) => (
                <a
                  key={mail}
                  href={`mailto:${mail}`}
                  className="block font-medium transition-opacity hover:opacity-80"
            ...
            <p className="mt-3 text-sm text-[#9CA3AF]">
              ...
              <Link href={entity.impressumHref} className="underline" style={{ color: theme.accent }}>
                Impressum
              </Link>{" "}
              entnommen werden.
            </p>
      ...
      content: (
        <div className="space-y-4">
          <Card>
            ...
            <p className="text-[#E5E7EB] leading-relaxed">340 S Lemon Ave #4133, Walnut, CA 91789, USA</p>
      ...
      content: (
        <div className="space-y-4">
          <Card>
            ...
            <Meta rows={[["Rechtsgrundlage", "Art. 6 Abs. 1 lit. f DSGVO"]]} />
          </Card>
          <Card>
    ...
    /* 15 — Consent */
    {
      ...
      content: (
        <Card>
          <Para>
            Zur Verwaltung Ihrer Einwilligungen verwenden wir ein eigenes Consent-Management. Ihre
            Auswahl wird lokal in Ihrem Browser (localStorage) gespeichert; dabei werden insbesondere
            die gewählten Kategorien sowie der Zeitpunkt der Einwilligung festgehalten. Eine
            Übermittlung an Dritte findet hierbei nicht statt.
          </Para>
          <Meta rows={[["Rechtsgrundlage", "Art. 6 Abs. 1 lit. c und lit. f DSGVO (Nachweis- und Dokumentationspflicht)"]]} />
        </Card>
      ),
    },
    ...
    /* 17 — Auftragsverarbeiter */
    {
      ...
      content: (
        <div className="space-y-4">
          <Card>
            <Para>
              Wir setzen ausschließlich sorgfältig ausgewählte Dienstleister ein, mit denen Verträge
              zur Auftragsverarbeitung gemäß Art. 28 DSGVO bestehen. Die nachfolgende Übersicht bildet
              die tatsächlich eingesetzten Dienste ab.
            </Para>
          </Card>
          <div
          ...
          >
            <div className="overflow-x-auto">
              <table className="w-full text-left text-[13.5px] text-[#E5E7EB]">
                <thead>
                  <tr className="uppercase tracking-wider text-[11px]" style={{ color: theme.accent, borderBottom: `1px solid rgba(${theme.accentRgb}, 0.25)` }}>
      ...
      content: (
        <div className="space-y-4">
          ...
          <Card>
            ...
            <a href={`mailto:${entity.primaryEmail}`} className="text-base font-semibold transition-opacity hover:opacity-80" style={{ color: theme.accent }}>
              {entity.primaryEmail}
            </a>
          </Card>
        </div>
