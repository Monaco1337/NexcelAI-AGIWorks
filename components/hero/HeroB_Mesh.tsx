...
export default function HeroB_Mesh() {
  ...
  return (
    ...
    >
      {/* ═══════════════════════════════════════════════════════════════
          PREMIUM SIGNATURE BACKGROUND - 5 Layers
      ═══════════════════════════════════════════════════════════════ */}
      <div className="absolute inset-0">
        ...
        {/* Layer 2: Aurora mesh - 3 radial gradients with blur */}
        <div
          className={`absolute inset-0 ${!prefersReducedMotion ? "hero-aurora-drift" : ""}`}
          style={{
            background: isDark
              ? `
                radial-gradient(ellipse 100% 80% at 15% 10%, rgba(139, 92, 246, 0.25) 0%, transparent 50%),
                radial-gradient(ellipse 80% 100% at 85% 90%, rgba(59, 130, 246, 0.18) 0%, transparent 50%),
                radial-gradient(ellipse 60% 60% at 50% 50%, rgba(168, 85, 247, 0.12) 0%, transparent 55%)
              `
              : `
                radial-gradient(ellipse 100% 80% at 15% 10%, rgba(139, 92, 246, 0.12) 0%, transparent 50%),
                radial-gradient(ellipse 80% 100% at 85% 90%, rgba(59, 130, 246, 0.08) 0%, transparent 50%),
                radial-gradient(ellipse 60% 60% at 50% 50%, rgba(168, 85, 247, 0.05) 0%, transparent 55%)
              `,
            filter: "blur(60px)",
          }}
        />

        {/* Layer 2b: Secondary aurora layer (offset animation) */}
        <div
          className={`absolute inset-0 ${!prefersReducedMotion ? "hero-aurora-drift-reverse" : ""}`}
          style={{
            background: isDark
              ? `
                radial-gradient(ellipse 70% 50% at 80% 20%, rgba(124, 58, 237, 0.15) 0%, transparent 50%),
                radial-gradient(ellipse 50% 70% at 20% 80%, rgba(79, 70, 229, 0.12) 0%, transparent 50%)
              `
              : `
                radial-gradient(ellipse 70% 50% at 80% 20%, rgba(124, 58, 237, 0.06) 0%, transparent 50%),
                radial-gradient(ellipse 50% 70% at 20% 80%, rgba(79, 70, 229, 0.04) 0%, transparent 50%)
              `,
            filter: "blur(80px)",
          }}
        />

        {/* Layer 3: Spotlight behind headline area */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: isDark
              ? "radial-gradient(ellipse 50% 40% at 25% 45%, rgba(168, 85, 247, 0.08) 0%, transparent 60%)"
              : "radial-gradient(ellipse 50% 40% at 25% 45%, rgba(168, 85, 247, 0.04) 0%, transparent 60%)",
          }}
        />

        {/* Layer 4: Vignette (dark edges) */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: isDark
      ...
      <style jsx>{`
        ...
        .hero-aurora-drift-reverse {
          animation: aurora-drift-reverse 30s ease-in-out infinite;
        }
